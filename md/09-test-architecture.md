...
### Q1. Что такое тестовая пирамида (Mike Cohn)?
...
### Q2. Что такое «Trophy» Кента Доддса и чем он лучше альтернатив?
...
### Q3. Какие виды тестов по уровню и цели существуют?
...
### Q4. В чём разница между Black-box, white-box и grey-box?
...
### Q6. Что такое современный Page Object на Playwright Java?
...
### Q8. Что такое Page Object и assertions?
...
### Q9. Что такое Page Factory (Selenium) и почему он считается устаревшим?
...
### Q11. В чём разница между Steps и Page Object?
...
### Q12. Что такое service Object для API?
...
### Q15. В чём разница между OCP — Open и Closed?
...
### Q19. Что такое Test Data Builder и зачем это нужно?
...
### Q20. Что такое Object Mother и зачем это нужно?
...
### Q21. Что такое фабрика тестовых данных через генератор?
...
### Q24. Что такое каноничная структура?
...
### Q25. Что такое слои и их зависимости?
...
### Q27. Что такое топ-15 антипаттернов?
