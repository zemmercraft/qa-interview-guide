...
### Q1. DDL / DML / DCL / TCL — категории команд
...
### Q2. Базовый SELECT — порядок выполнения
...
### Q8. Типичная задача с JOIN на собесе: «найти пользователей без заказов»
...
### Q11. Различные комбинации COUNT
...
### Q13. CTE (Common Table Expression) — WITH
...
### Q14. Window functions — главное оружие senior'а
...
### Q18. SAVEPOINT — частичный rollback
...
### Q19. Аномалии параллельных транзакций
...
### Q20. Уровни изоляции (SQL Standard)
...
### Q22. Optimistic vs Pessimistic locking
...
### Q24. Composite index — порядок столбцов важен
...
### Q28. «Найти второй по величине зарплате»
...
### Q31. «Средняя сумма заказа по месяцам»
...
### Q32. «Пользователи, которые ничего не покупали последние 30 дней»
...
### Q33. «Cumulative sum / running total»
...
### Q34. SQL для QA Auto: проверка после API/UI
